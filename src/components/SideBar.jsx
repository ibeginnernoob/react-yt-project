    ...
    return <div>
        ...
        <aside id="separator-sidebar" className="fixed left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-white">
                <ul className="space-y-0.1 font-medium">
                    <li>
                        <a href="#" className="flex items-end p-2 text-black font-roboto font-[400] text-sm  rounded-lg hover:bg-zinc-100 group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                        </svg>
                        <span className="ml-8 ms-3">Home</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" className=" flex items-end p-2 text-black font-roboto font-[400] text-sm  rounded-lg hover:bg-zinc-100 group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="4" viewBox="0 0 24 24" width="4" focusable="false" aria-hidden="true" className="pointer-events-none w-[12%] h-[12%] block">
                        ...
                        <span className="ml-8 flex-1 ms-3 whitespace-nowrap">Shorts</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" className="flex items-end p-2 text-black font-roboto font-[400] text-sm  rounded-lg hover:bg-zinc-100 group">
                        ...
                        <span className="flex-1 ms-3 whitespace-nowrap ml-8">Subscriptions</span>
                        </a>
                    </li>
                </ul>
                ...
                <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200">
                    ...
                    <li>
                        <a href="#" className="flex items-end p-2 text-black font-roboto font-[400] text-sm  rounded-lg hover:bg-zinc-100 group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true" className="pointer-events-none w-[12%] h-[12%] block">
                        ...
                        <span className="ml-8 ms-3">History</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" className=" flex items-end p-2 text-black font-roboto font-[400] text-sm  rounded-lg hover:bg-zinc-100 group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true" className="pointer-events-none w-[12%] h-[12%] block">
                            <path clipRule="evenodd" d="M3.75 5c-.414 0-.75.336-.75.75s.336.75.75.75h16.5c.414 0 .75-.336.75-.75S20.664 5 20.25 5H3.75Zm0 4c-.414 0-.75.336-.75.75s.336.75.75.75h16.5c.414 0 .75-.336.75-.75S20.664 9 20.25 9H3.75Zm0 4c-.414 0-.75.336-.75.75s.336.75.75.75h8.5c.414 0 .75-.336.75-.75s-.336-.75-.75-.75h-8.5Zm8.5 4c.414 0 .75.336.75.75s-.336.75-.75.75h-8.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h8.5Zm3.498-3.572c-.333-.191-.748.05-.748.434v6.276c0 .384.415.625.748.434L22 17l-6.252-3.572Z" fillRule="evenodd"></path>
                        </svg>
                        <span className="ml-8 flex-1 ms-3 whitespace-nowrap">Playlists</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" className="flex items-end p-2 text-black font-roboto font-[400] text-sm  rounded-lg hover:bg-zinc-100 group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true" className="pointer-events-none w-[12%] h-[12%] block">
                            <path clipRule="evenodd" d="M3.5 5.5h17v13h-17v-13ZM2 5.5C2 4.672 2.672 4 3.5 4h17c.828 0 1.5.672 1.5 1.5v13c0 .828-.672 1.5-1.5 1.5h-17c-.828 0-1.5-.672-1.5-1.5v-13Zm7.748 2.927c-.333-.19-.748.05-.748.435v6.276c0 .384.415.625.748.434L16 12 9.748 8.427Z" fillRule="evenodd"></path>
                        </svg>
                        <span className="flex-1 ms-3 whitespace-nowrap ml-8">Your Videos</span>
                        </a>
                    </li>
                </ul>
            </div>
