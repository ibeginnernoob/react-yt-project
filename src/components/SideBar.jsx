function SideBar(){
    return <div>
        ...
        <aside id="separator-sidebar" className="fixed top-[100px] left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
